A Terraform/CX as Code remote module for the following Genesys Cloud public API operation: Update External Contact
...
```hcl
module "data_action" {
    source             = "git::https://github.com/GenesysCloudDevOps/public-api-update-external-contact-data-action-module.git?ref=main"
    action_name        = "Update External Contact"
